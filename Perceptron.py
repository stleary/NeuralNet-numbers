...
class Perceptron:
    ...
    def train(self, values: [], target: int):
        ...
        wrong, the bias and the weight for each input will be adjusted.
        ...
        if (target != result):
            # the result was incorrect. Modify the bias and weights according to whether 0 or 1 was expected
            for i in range(len(self.weights)):
